...
export default function Home() {
  ...
  return (
    <div className="flex flex-col relative bg-background font-raleway items-center min-h-screen" style={{backgroundImage: "url('124778529-cryptocurrency-around-the-world-seamless-background-crypto-currency-symbol.webp')"}}>
      <h1 className="text-6xl text-primary font-bold mt-20">
        Crypto <span className="text-active">Market</span>
      </h1>
      <h2 className="text-active text-2xl mt-6">
        Get the latest news on what's happening in Crypto Currency World.
